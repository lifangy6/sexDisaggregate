...
## Description
`sexDisaggregate` is is an R package that separates .csv datasets by sex, performs comparison visualization and helps users to examine their datasets from a sex-disaggregated perspective.
